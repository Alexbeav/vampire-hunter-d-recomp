# Vampire Hunter D Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/vampire-hunter-d-recomp/total)](https://github.com/Alexbeav/vampire-hunter-d-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/vampire-hunter-d-recomp/latest/total)](https://github.com/Alexbeav/vampire-hunter-d-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/vampire-hunter-d-recomp)](https://github.com/Alexbeav/vampire-hunter-d-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Vampire Hunter D** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Vampire Hunter D.
...
Zip prefix for CI artifacts: `Vampire-Hunter-D-Recomp`.
...
The `v0.3.3` source uses `Vampire_Hunter_D_Recompiled` in CMake, the setup relaunch, and the packager.
