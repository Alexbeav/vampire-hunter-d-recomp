...
#
# Writes: dist/Vampire-Hunter-D-Recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix Vampire-Hunter-D-Recomp \
  --exe-name Vampire_Hunter_D_Recompiled \
  --display-name "Vampire Hunter D Recompiled" \
