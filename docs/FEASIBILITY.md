# Vampire Hunter D release feasibility
...
The supported serial set is $(@{ordinal=24; slug=vampire-hunter-d; title=Vampire Hunter D; serials=System.Object[]; expected_disc_count=1; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
