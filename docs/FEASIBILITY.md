...
The supported serial set is `SLUS-01138`. The package uses
...
The corrected source uses `Vampire_Hunter_D_Recompiled` for CMake, the setup relaunch, and packaging.
