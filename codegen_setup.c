...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "vampire-hunter-d-",
    .project_root_env = "VAMPIRE_HUNTER_D_RECOMP_PROJECT_ROOT",
    .build_dir_env = "VAMPIRE_HUNTER_D_RECOMP_BUILD_DIR",
    .force_setup_env = "VAMPIRE_HUNTER_D_RECOMP_FORCE_SETUP",
